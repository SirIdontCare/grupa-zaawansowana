...
Cześć! To małe ćwiczenie przygotowałem dla Was na **Moduł 3 Advanced Tracku**. — *Paweł*
...
Techniki (jak czytać stack trace, jak użyć `console.log`, jak postawić breakpoint w VS Code) oraz sposób oddania pracy znajdziesz w pliku **`W3_DEBUG.md`** w materiałach Advanced Tracku (na naszym kanale).
